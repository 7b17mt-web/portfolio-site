...
$(document).ready(function () {
  // getelementbyclassnameで個数を取得して、slidetoshowに個数を設定
  $('.work_slider').slick({
    dots: false,
    arrows: true,
    initialSlide: 0,
    ...
    infinite: false,
    autoplay: false,
    nextArrow: '<button type="button" class="slick-button-next"><p class="custom-next">Next →</p></button>',
    prevArrow: '<button type="button" class="slick-button-prev"><p class="custom-prev">← prev</p></button>',
    slidesToShow: 3,
    responsive: [
      {
        breakpoint: 960,
